                ...
                <div class="edit-pics">
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">FRONT-END TEAM</a></h5>
                    ...
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">BACKEND TEAM</a></h5>
                            <div class="td-post-date two"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">TEAM INFORMATION</a></h5>
                            <div class="td-post-date two"> </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
